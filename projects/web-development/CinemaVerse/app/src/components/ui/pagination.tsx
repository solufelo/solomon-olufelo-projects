...
// Define the pagination components directly
const Pagination = ({ children, className }: { children: React.ReactNode; className?: string }) => (
  <nav className={cn('flex items-center justify-center', className)}>{children}</nav>
);
...
const PaginationPrevious = ({ href, onClick, className }: { href: string; onClick?: (e: React.MouseEvent) => void; className?: string }) => (
  <a 
    href={href} 
    onClick={onClick}
    className={cn(
...
const PaginationNext = ({ href, onClick, className }: { href: string; onClick?: (e: React.MouseEvent) => void; className?: string }) => (
  <a 
    href={href} 
    onClick={onClick}
    className={cn(
