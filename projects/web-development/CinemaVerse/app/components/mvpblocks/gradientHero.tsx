    ...
    <div className="relative w-full overflow-hidden bg-background">
      ...
      <div className="container relative z-10 mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          >
            <Button
              className="group relative overflow-hidden rounded-full bg-primary px-6 py-3 text-primary-foreground shadow-lg transition-all duration-300 hover:shadow-primary/30"
            >
            ...
            <Button
              className="flex items-center gap-2 rounded-full border border-border bg-background/50 px-6 py-3 backdrop-blur-sm"
            >
