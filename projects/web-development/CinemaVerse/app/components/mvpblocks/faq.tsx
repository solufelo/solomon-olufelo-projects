            ...
            {items.map((item, index) => (
              ...
              >
                <AccordionItem
                  value={item.id}
                  className={
                    'my-1 overflow-hidden rounded-lg border-none bg-card/50 px-2 shadow-sm transition-all data-[state=open]:bg-card/80 data-[state=open]:shadow-md'
                  }
                >
                  <AccordionPrimitive.Header className="flex">
                    <AccordionPrimitive.Trigger
                      className={
                        'group flex flex-1 items-center justify-between gap-4 py-4 text-left text-base font-medium outline-none transition-all duration-300 hover:text-primary focus-visible:ring-2 focus-visible:ring-primary/50 data-[state=open]:text-primary'
                      }
                    >
                      {item.title}
                      <PlusIcon
                        size={18}
                        className={
                          'shrink-0 text-primary/70 transition-transform duration-300 ease-out group-data-[state=open]:rotate-45'
                        }
                        aria-hidden="true"
                      />
                    </AccordionPrimitive.Trigger>
                  ...
                  <AccordionContent
                    className={
                      'overflow-hidden pb-4 pt-0 text-muted-foreground data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up'
                    }
                  >
